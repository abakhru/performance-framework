"""
runner.py — Run lifecycle, k6 process management, SLO checks, webhooks,
...
import core.influx as _influx
from core.influx import influx_query, influx_write, lp_str, lp_tag, now_ns
from core.storage import HOOKS_DIR, REPO_ROOT, load_webhooks
...
def finalize_run(
    ...
    """
    from core.storage import coerce_int as _int
