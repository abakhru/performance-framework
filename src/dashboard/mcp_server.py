...
def list_saved_configs() -> list:
    ...
    """
    from core.storage import list_saved_configs as _list
...
def load_saved_config(filename: str) -> dict:
    ...
    """
    from core.storage import load_named_config
...
def save_endpoint_config(
    ...
    from core.storage import save_named_config
...
def run_status() -> dict:
    ...
    from plugins.performance.runner import _k6_lock, _k6_state
