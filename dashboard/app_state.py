"""Shared mutable application state, safe to import from any router."""

from storage import build_op_group, load_endpoint_config
from storage import save_endpoints_json as _save_storage
